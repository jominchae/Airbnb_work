...
class SliderController {
  constructor(sliderId) {
    ...
    this.currentSlide = 0;
    this.totalSlides = 5;
    this.isAutoPlay = false; // “정지 상태”로 시작 (슬라이드 정지 상태)
  ...
  setInitialButtonState() {
    ...
    if (toggleBtn) {
      ...
      if (img) {
        if (this.isAutoPlay) {
          img.src = "/images/play-btn.png"; // 재생 아이콘
          img.alt = "재생";
        } else {
          img.src = "/images/pause-btn.png"; // 정지 아이콘
          img.alt = "정지";
        }
      }
    }
  ...
  toggleAutoPlay() {
    this.isAutoPlay = !this.isAutoPlay; // 상태 반전
